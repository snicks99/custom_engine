...
# START CONFIG FOR DBO
if(DBO_CLIENT_DIR)
  set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${DBO_CLIENT_DIR})
  set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO ${DBO_CLIENT_DIR})
endif()

set(DBO_LINK_DIRECTORIES 	
  ${PROJECT_SOURCE_DIR}/lib/  
  ${PROJECT_SOURCE_DIR}/lib/Renderware
  ${PROJECT_SOURCE_DIR}/lib/D3D9
  ${PROJECT_SOURCE_DIR}/lib/fmod
  ${PROJECT_SOURCE_DIR}/lib/GFx
  ${PROJECT_SOURCE_DIR}/lib/FiberTaskLib
  ${PROJECT_SOURCE_DIR}/lib/OptickCore
  ${PROJECT_SOURCE_DIR}/lib/BugTrap
  ${PROJECT_SOURCE_DIR}/lib/libjpeg
  ${PROJECT_SOURCE_DIR}/lib/DevIL
  ${PROJECT_SOURCE_DIR}/lib/ToolkitPro  
)
# add_definitions(/MP /GL /FC)
