...
message("* Brach: ${rev_branch}")
message("* Date:  ${rev_date}")
message("* Hash:  ${rev_hash}")
if(UNIX)
...
message("********************* CLIENT/TOOLS/SERVER ************************")
if( DBO_SERVER )
  message("* Build Server           : Yes")
else()
  message("* Build Server           : No  (default)")
endif()
...
message("************************* CLIENT DIR *****************************")
if(DBO_CLIENT_DIR)
  message("* Client DIR                 : ${DBO_CLIENT_DIR}")
else()
  message(" *** Client DIR not found, using default, please set your client DIR *** ")
endif()
message("******************************************************************")
message("")
