...
#if MGE_COMPILER == MGE_COMPILER_MICROSOFT
...
#define WPAssert( cond, ... )                                                                                       \
    ASSERT_BEGIN do                                                                                                 \
    {                                                                                                               \
        if ( !( cond ) ) Trinity::Assert( __FILE__, __LINE__, __FUNCTION__, GetDebugInfo(), #cond, ##__VA_ARGS__ ); \
    }                                                                                                               \
    while ( 0 )                                                                                                     \
    ASSERT_END
#define WPAssert_NODEBUGINFO( cond, ... )                                                               \
    ASSERT_BEGIN do                                                                                     \
    {                                                                                                   \
        if ( !( cond ) ) Trinity::Assert( __FILE__, __LINE__, __FUNCTION__, "", #cond, ##__VA_ARGS__ ); \
    }                                                                                                   \
    while ( 0 )                                                                                         \
    ASSERT_END
#define WPFatal( cond, ... )                                                                \
    ASSERT_BEGIN do                                                                         \
    {                                                                                       \
        if ( !( cond ) ) Trinity::Fatal( __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__ ); \
    }                                                                                       \
    while ( 0 )                                                                             \
    ASSERT_END
#define WPError( cond, msg )                                                          \
    ASSERT_BEGIN do                                                                   \
    {                                                                                 \
        if ( !( cond ) ) Trinity::Error( __FILE__, __LINE__, __FUNCTION__, ( msg ) ); \
    }                                                                                 \
    while ( 0 )                                                                       \
    ASSERT_END
#define WPWarning( cond, msg )                                                          \
    ASSERT_BEGIN do                                                                     \
    {                                                                                   \
        if ( !( cond ) ) Trinity::Warning( __FILE__, __LINE__, __FUNCTION__, ( msg ) ); \
    }                                                                                   \
    while ( 0 )                                                                         \
    ASSERT_END
#define WPAbort()                                                           \
    ASSERT_BEGIN do { Trinity::Abort( __FILE__, __LINE__, __FUNCTION__ ); } \
    while ( 0 )                                                             \
    ASSERT_END
#define WPAbort_MSG( msg, ... )                                                                     \
    ASSERT_BEGIN do { Trinity::Abort( __FILE__, __LINE__, __FUNCTION__, ( msg ), ##__VA_ARGS__ ); } \
    while ( 0 )                                                                                     \
    ASSERT_END
